...
//	@SneakyThrows(IOException.class)
	public void indexCategoryFromJsonFile(Client client, String jsonFile,String categoryName) {
		InputStream inJson = ElasticSearchEmbeddedServer.class.getResourceAsStream("/test/elasticsearch/" + jsonFile);
		String json = null;
//		try {
...
//		}
		...
		client.prepareIndex(ES_INDEX, categoryName).setSource(json).execute().actionGet();
	}
}
